...
module.exports = {
  ...
  backup:function(){
    //sesscln();
    $.fs.writeFileSync(module.exports.sstore,$.lib.fn.jsonString($.sstore.sessions));
  ...
  restore:function(cb){
    try {
      if($.lib.fn.fileOlder(module.exports.sstore,module.exports.maxage)) throw 'session file is too old.';
      else {
